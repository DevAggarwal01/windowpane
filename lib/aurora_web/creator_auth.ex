defmodule AuroraWeb.CreatorAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_aurora_web_creator_remember_me"
  ...
  the current_creator:
      ...
      defmodule AuroraWeb.PageLive do
        ...
        on_mount {AuroraWeb.CreatorAuth, :mount_current_creator}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AuroraWeb.CreatorAuth, :ensure_authenticated}] do
