defmodule AuroraWeb.CreatorDashboardLive do
          ...
          <div class="flex justify-between h-16">
            <div class="flex">
              <div class="flex-shrink-0 flex items-center">
                <img class="h-8 w-auto" src={~p"/images/logo.png"} alt="Aurora Studio" />
                <span class="ml-2 text-lg font-semibold text-gray-900">Studio</span>
              </div>
            </div>
            <div class="flex items-center space-x-4">
              <div class="flex-shrink-0 flex items-center">
                <span class="text-sm text-gray-500">Creator Dashboard</span>
              </div>
          ...
          <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
            <div class="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="#" class="font-medium text-brand hover:text-accent">View all</a>
                </div>
              </div>
            </div>
            ...
            <div class="bg-white overflow-hidden shadow rounded-lg">
              ...
              <div class="bg-gray-50 px-5 py-3">
                <div class="text-sm">
                  <a href="#" class="font-medium text-brand hover:text-accent">View details</a>
                </div>
              </div>
            </div>
          </div>
