defmodule WindowpaneWeb.CreatorLoginLive do
  ...
  def render(assigns) do
    ...
    <div class="min-h-screen bg-[#0073b1]">
      <div class="flex flex-col items-center pt-10 px-4">
        <div class="mb-6">
          <img src={~p"/images/logo-white.png"} alt="Windowpane Studio" class="h-8" />
        </div>
          ...
          <div class="mt-6 text-center">
            <div class="relative">
              ...
              <div class="relative flex justify-center text-sm">
                <span class="px-2 bg-white text-gray-500">New to Windowpane Studio?</span>
              </div>
            </div>
