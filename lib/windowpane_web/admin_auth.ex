defmodule WindowpaneWeb.AdminAuth do
  ...
  @max_age 60 * 60 * 24 * 60
  @remember_me_cookie "_windowpane_web_admin_remember_me"
  ...
  the current_admin:
      ...
      defmodule WindowpaneWeb.PageLive do
        ...
        on_mount {WindowpaneWeb.AdminAuth, :mount_current_admin}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{WindowpaneWeb.AdminAuth, :ensure_authenticated}] do
